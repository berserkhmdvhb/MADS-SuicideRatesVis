...
# **Introduction**
This projects aims at extracting patterns and information from the number of suicides that have occurred through years 1985-2016.The [suicide rates dataset](https://www.kaggle.com/russellyates88/suicide-rates-overview-1985-to-2016) was pulled from four other datasets linked by time and place, and was built to find signals correlated to increased suicide rates among different cohorts globally, across the socio-economic spectrum. The dataset has the following variables (columns):
...
Raising awareness of public about mental health help in detecting and preventing mental disorders. And this would also help in preventing suicide since suicide usually occurs after a major depressive episode. However, suicide can have other reasons, such as substance uses and even it can occur in absence of any psychiatric disorder. Therefore, suicide requires more care and attention, which can be achieved by understanding its influencing factors. 
[@suic] categorizes major factors in the following figure:

![Suicide Influencing Factors](factors.jpg)

All the factors are categorized by age level. This means that age is significant. Moreover, from economic factors, GDP per capita is one of the income quality metrics which measure the distribution of income between rich and poor. Therefore, GDP per capita can be regarded as one of the economic factors stated in the previous figure.
We aim at providing insights on effect of age, continent, and Gross Domestic Product (GDP) per capita, which are presented in the sections [Age Analysis](#age), [Continent Gradient](#continent), and [GDP Animation](#gdp). We also provide two hypothesis tests to draw conclusions on data.
...
We observe that the density reaches its highest values in the continents Europe, Oceania, and Asia. Moreover, suicide rates of values greater than 20 are more probable in Europe than other continents.
